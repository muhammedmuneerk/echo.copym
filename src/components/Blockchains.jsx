...
const blockchains = [
  ...
  {
    name: "Binance",
    logo: <img src="/assets/icons/binance-bgremoved.png" alt="Binance" className="w-8 h-8" />,
  },
  {
    name: "Cardano",
    logo: <img src="/assets/icons/cardano-removebg-circle.png" alt="Cardano" className="w-10 h-10" />,
  },
  {
    name: "Optimism",
    logo: <img src="/assets/icons/optimism-removebg.png" alt="Optimism" className="w-9 h-9" />,
  },
];
    ...
    <Box className="py-24 relative overflow-hidden" >  
      ...
      <Container maxWidth="xl">
            ...
            >
              {[...blockchains, ...blockchains].map((blockchain, index) => (
                <Box
                  ...
                  sx={{
                    width: { xs: "32.5vw", sm: "32.5vw", md: "32.5vw", lg: "20vw" },
                    padding: 2,
                    flexShrink: 0
                  }}
                >
                  <motion.div
                    ...
                    style={{
                      background: isMobile ? "transparent" : "rgba(18, 19, 26, 0.7)",
                      backdropFilter: isMobile ? "none" : "blur(12px)",
                      border: isMobile ? "none" : "1px solid rgba(255, 255, 255, 0.15)",
                    }}
                  >
                    <Box className="w-16 h-16 mb-4 rounded-full flex items-center justify-center" sx={{ background: "rgba(255, 255, 255, 0.1)" }}>
                      {blockchain.logo}
                    </Box>
        ...
        <Box
          ...
          sx={{
            background: "radial-gradient(circle at 50% 50%, rgba(0, 255, 133, 0.05) 0%, rgba(10, 11, 13, 0) 50%)",
          }}
        />
      </Container>
    </Box>
