    ...
    <Box className="py-24 bg-background/50">
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            Consistent growth in tokenized assets across all classes with
          ...
          <Box
            className={`w-full mb-16 transition-all duration-700 rounded-2xl p-4 border border-gray-100 shadow-lg  backdrop-blur-sm`}
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    {chartType === "line" ? (
                      ...
                      >
                        ...
                        <Legend
                          formatter={(value) => {
                            if (value === "assets") return "Assets (Billions)";
                            if (value === "users") return "Users (Thousands)";
                            return "Transactions (Millions)";
                          }}
                          verticalAlign={isMobile ? "bottom" : "top"}
                          wrapperStyle={{ paddingBottom: isMobile ? 20 : 0 }}
                        />
                        <ReferenceLine
                          y={0}
                          stroke="#000"
                        ...
                        <Line
                          ...
                          name="assets"
                          stroke="#8884d8"
                          strokeWidth={highlightedMetric === 0 ? 4 : 2}
                          dot={{ r: highlightedMetric === 0 ? 6 : 4 }}
                        ...
                        <Line
                          ...
                          name="users"
                          stroke="#82ca9d"
                          strokeWidth={highlightedMetric === 1 ? 4 : 2}
                          dot={{ r: highlightedMetric === 1 ? 6 : 4 }}
                          activeDot={{ r: 8, strokeWidth: 2 }}
                          animationDuration={2000}
                          animationBegin={600}
                        />
                        <Line
                          ...
                          name="transactions"
                          stroke="#ffc658"
                          strokeWidth={highlightedMetric === 3 ? 4 : 2}
                          dot={{ r: highlightedMetric === 3 ? 6 : 4 }}
                          activeDot={{ r: 8, strokeWidth: 2 }}
                          animationDuration={2000}
                          animationBegin={900}
                        />
