 ...
 * Creates a custom cursor effect with a trailing outer circle
 */
export const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    if (cursorRef.current && cursorOuterRef.current) {
      ...
      // Outer cursor follows with slight delay for trail effect
    ...
    <div className="cursor-container">
      ...
      <div 
        ...
        style={{
          ...
          zIndex: 9999,
          transform: "translate(-50%, -50%)",
          boxShadow: "0 0 10px rgba(0, 255, 133, 0.6)"
        }}
      />
    </div>
  );
