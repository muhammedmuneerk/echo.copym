...
const ESGFocusSection = () => {
  return (
    <section className="relative px-4 py-20 bg-white text-[#333] overflow-hidden z-10 space-y-24">
      {/* Animated Grid Lines */}
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 bg-white bg-opacity-70 border border-[#00A86B]/20 shadow-lg shadow-green-300/10 rounded-2xl p-8 backdrop-blur-md">
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-8 bg-white bg-opacity-70 border border-[#00A86B]/20 shadow-lg shadow-green-300/10 rounded-2xl p-8 backdrop-blur-md">
        <div className="md:w-1/2">
      ...
      <div className="relative max-w-5xl mx-auto text-center bg-white bg-opacity-70 p-8 rounded-2xl border border-[#00A86B]/20 backdrop-blur-md shadow-lg shadow-green-300/10">
